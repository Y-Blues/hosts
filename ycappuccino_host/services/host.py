...
class Host(IHost):
    ...
    def __init__(self):
        ...
        self.path_core = inspect.getmodule(self).__file__.replace("ycappuccino_host{0}services{0}host.py".format(os.path.sep), "")
        self.path_app = inspect.getmodule(self).__file__.replace("hosts{0}ycappuccino_host{0}services{0}host.py".format(os.path.sep), "")
        self._log =None
        self._secure =None
        self._user = None
        self._pass =None
